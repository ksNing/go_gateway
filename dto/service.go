...
type ServiceListInput struct {
	...
	PageSize int    `json:"page_size" form:"page_size" comment:"每条页数" example:"20" validate:"required"`
}

type ServiceStatOutPut struct {
	Today     []int64 `json:"today" form:"today" comment:"今日数据" example:"" validate:""`
	Yesterday []int64 `json:"yesterday" form:"yesterday" 昨日数据:"关键词" example:"" validate:""`
}
